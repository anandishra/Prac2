...
if ($_SERVER["REQUEST_METHOD"] == 'GET') {
  ...
  $email = $_POST["email"];
  $server = $_POST["server"];
  $server = $_POST["expdate"];

  $sql = "update crud2 set name='$name', email='$email', server='$server' ,expdate='$expdate where id='$id'";
  $result = $conn->query($sql);
}
  ...
  <div class="col-lg-6 m-auto">
    ...
    <form method="post">
      ...
      <div class="card">
        ...
        <label>SERVER</label>
        <input type="text" name="server" value="<?php echo $server; ?>" class="form-control"> <br>
